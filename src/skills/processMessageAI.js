...
export default async function processMessage(message) {
  ...
  if (
    ...
    const dynamicPrompt = {
      role: 'system',
      content: `Você é um assistente que pode responder perguntas, usar agentes especializados para gerar imagens, analisar imagens, criar lembretes, verificar resultados de loterias e **gerar áudio usando a ferramenta 'audio_generation_agent'**.
